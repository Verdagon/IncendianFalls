...
public class GlaiveAsIOffenseFactorUC : IOffenseFactorUC {
  public readonly Glaive obj;
  public int id => obj.id;
  public Root root => obj.root;
  public void Delete() { obj.Delete(); }
  public bool Exists() { return obj.Exists(); }
  public GlaiveAsIOffenseFactorUC(Glaive obj) {
    this.obj = obj;
  }
  ...
  public int GetOutgoingDamageAddConstant() {
    return GlaiveExtensions.GetOutgoingDamageAddConstant(obj);
  }
  public int GetOutgoingDamageMultiplierPercent() {
    return GlaiveExtensions.GetOutgoingDamageMultiplierPercent(obj);
  }

}
public static class GlaiveAsIOffenseFactorUCCaster {
  public static GlaiveAsIOffenseFactorUC AsIOffenseFactorUC(this Glaive obj) {
    return new GlaiveAsIOffenseFactorUC(obj);
  }
}

...
public class NullIMovementTimeFactorUC : IMovementTimeFactorUC {
  public static NullIMovementTimeFactorUC Null = new NullIMovementTimeFactorUC();
  ...
  public int GetMovementTimeAddConstant() {
    throw new Exception("Called GetMovementTimeAddConstant on a null!");
  }
             
  public int GetMovementTimeMultiplierPercent() {
    throw new Exception("Called GetMovementTimeMultiplierPercent on a null!");
  }

...
public class NullICombatTimeFactorUC : ICombatTimeFactorUC {
  public static NullICombatTimeFactorUC Null = new NullICombatTimeFactorUC();
  ...
  public int GetCombatTimeAddConstant() {
    throw new Exception("Called GetCombatTimeAddConstant on a null!");
  }
             
  public int GetCombatTimeMultiplierPercent() {
    throw new Exception("Called GetCombatTimeMultiplierPercent on a null!");
  }

...
public class TutorialLevelControllerAsILevelController : ILevelController {
  ...
  public Void SimpleTrigger(Game game, Superstate superstate, string triggerName) {
    return TutorialLevelControllerExtensions.SimpleTrigger(obj, game, superstate, triggerName);
  }
  public Void SimpleUnitTrigger(Game game, Superstate superstate, Unit triggeringUnit, Location location, string triggerName) {
    return TutorialLevelControllerExtensions.SimpleUnitTrigger(obj, game, superstate, triggeringUnit, location, triggerName);
  }

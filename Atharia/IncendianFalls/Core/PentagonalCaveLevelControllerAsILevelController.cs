...
public class PentagonalCaveLevelControllerAsILevelController : ILevelController {
  ...
  public Void SimpleTrigger(Game game, Superstate superstate, string triggerName) {
    return PentagonalCaveLevelControllerExtensions.SimpleTrigger(obj, game, superstate, triggerName);
  }
  public Void SimpleUnitTrigger(Game game, Superstate superstate, Unit triggeringUnit, Location location, string triggerName) {
    return PentagonalCaveLevelControllerExtensions.SimpleUnitTrigger(obj, game, superstate, triggeringUnit, location, triggerName);
  }

...
public class Game {
  ...
  public bool Is(Game that) {
    ...
    return this.root == that.root && id == that.id;
         ...
         public Rand rand {
    get { return new Rand(root, incarnation.rand); }
  }
  public bool squareLevelsOnly {
    get { return incarnation.squareLevelsOnly; }
  }
  public LevelMutBunch levels {
    get { return new LevelMutBunch(root, incarnation.levels); }
  }
  public Unit player {
    get { return new Unit(root, incarnation.player); }
    set { root.EffectGameSetPlayer(id, value); }
  }
  public Level level {
    get { return new Level(root, incarnation.level); }
  ...
  public ExecutionState executionState {
    get { return new ExecutionState(root, incarnation.executionState); }
  }
}
}

...
public class RootIncarnation {
  ...
  public readonly SortedDictionary<int, VersionAndIncarnation<BideImpulseIncarnation>> incarnationsBideImpulse;
  public readonly SortedDictionary<int, VersionAndIncarnation<BideAICapabilityUCIncarnation>> incarnationsBideAICapabilityUC;
  public readonly SortedDictionary<int, VersionAndIncarnation<BidingUCIncarnation>> incarnationsBidingUC;
  ...
  public RootIncarnation(int version, int nextId, int hash) {
    ...
    this.incarnationsBideImpulse = new SortedDictionary<int, VersionAndIncarnation<BideImpulseIncarnation>>();
    this.incarnationsBideAICapabilityUC = new SortedDictionary<int, VersionAndIncarnation<BideAICapabilityUCIncarnation>>();
    this.incarnationsBidingUC = new SortedDictionary<int, VersionAndIncarnation<BidingUCIncarnation>>();
  ...
  public RootIncarnation(
    ...
    this.incarnationsBideImpulse = new SortedDictionary<int, VersionAndIncarnation<BideImpulseIncarnation>>(that.incarnationsBideImpulse);
    ...
    this.incarnationsBidingUC = new SortedDictionary<int, VersionAndIncarnation<BidingUCIncarnation>>(that.incarnationsBidingUC);

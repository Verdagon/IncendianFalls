...
public class PatternTile : IComparable<PatternTile> {
  ...
  public readonly PatternSideAdjacencyImmList sideAdjacenciesBySideIndex;
  public readonly PatternCornerAdjacencyImmListImmList cornerAdjacenciesByCornerIndex;
  public PatternTile(
      int shapeIndex,
      float rotateDegrees,
      Vec2 translate,
      PatternSideAdjacencyImmList sideAdjacenciesBySideIndex,
  ...
  public string DStr() {
    ...
    public static PatternTile Parse(ParseSource source) {
      ...
      source.Expect(",");
      var sideAdjacenciesBySideIndex = PatternSideAdjacencyImmList.Parse(source);
      source.Expect(",");

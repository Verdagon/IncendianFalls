...
public class PatternCornerAdjacencyImmListImmList {
  ...
  public PatternCornerAdjacencyImmListImmList(PatternCornerAdjacencyImmList[] list) {
    this.list = new List<PatternCornerAdjacencyImmList>(list);
  }
  public PatternCornerAdjacencyImmListImmList(List<PatternCornerAdjacencyImmList> list) {
    this.list = list;
  }

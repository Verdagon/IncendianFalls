...
public class BideAICapabilityUCAsIAICapabilityUC : IAICapabilityUC {
  ...
  public IImpulse ProduceImpulse(Game game, Superstate superstate, Unit unit) {
    return BideAICapabilityUCExtensions.ProduceImpulse(obj, game, superstate, unit);
  }

}
public static class BideAICapabilityUCAsIAICapabilityUCCaster {
  public static BideAICapabilityUCAsIAICapabilityUC AsIAICapabilityUC(this BideAICapabilityUC obj) {
    return new BideAICapabilityUCAsIAICapabilityUC(obj);
  }
}
